...
t
    ...
    removeTodo(id) {
        this.todoList.filter(todo => {
            return todo.id !== parseInt(id); //아이디랑 같지 않은것 만 배열에 담는다
        });
            ...
            return `
              <li class="todolist-items">
							<div class="item-left">
                                ...
                                ${todo.compleStatus ? "checked" : ""} value="${todo.id}" onchange="checkedOnChangeHandle(this);">
